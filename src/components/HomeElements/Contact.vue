<template>
    <div>
        ...
        <section id="Escribenos" class="relative bg-fade1 text-texttone flex flex-col justify-center xl:flex-row flex-wrap xl:justify-evenly items-center h-screen w-fil ">
