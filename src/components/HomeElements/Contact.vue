<template>
    <div>
        ...
        <section id="Contactanos" class="relative bg-fade1 text-texttone flex flex-col justify-center xl:flex-row flex-wrap xl:justify-evenly items-center h-screen w-fil ">

                    <div>
                        <h2 class="text-texttone  sm:text-8xl text-2xl text-center font-bold py-2 aos-item" data-aos="fade-right">Contáctanos</h2> 
