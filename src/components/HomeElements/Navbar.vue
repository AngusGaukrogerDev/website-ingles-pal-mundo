<template>
    <header class="bg-fade1 w-full fixed top-0 z-50 overflow-hidden " data-aos="fade-left">       
        <nav class=" px-5 py-6 mx-auto xl:flex xl:justify-between xl:items-center">
